...
static int vdd_gx_corner[] = {
	...
	RPMH_REGULATOR_LEVEL_RETENTION + 4,	/* VDD_GX_RETENTION */ // 16
	RPMH_REGULATOR_LEVEL_MIN_SVS - 16,		/* VDD_GX_MIN */ // 48
	RPMH_REGULATOR_LEVEL_LOW_SVS - 16,		/* VDD_GX_LOWER */ // 64
	RPMH_REGULATOR_LEVEL_SVS - 32,		/* VDD_GX_LOW */ // 128
	RPMH_REGULATOR_LEVEL_SVS_L1 - 32,		/* VDD_GX_LOW_L1 */ // 192
	RPMH_REGULATOR_LEVEL_NOM - 32,		/* VDD_GX_NOMINAL */ // 256
	RPMH_REGULATOR_LEVEL_NOM_L1 - 32,		/* VDD_GX_NOMINAL_L1 */ // 320
...
static struct clk_rcg2 gpu_cc_gx_gfx3d_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.rate_max = (unsigned long[VDD_GX_NUM]) {
			...
			[VDD_GX_MIN] = 430000000,
			[VDD_GX_LOW] = 565000000,
			[VDD_GX_LOW_L1] = 650000000,
			[VDD_GX_NOMINAL] = 800000000,
			[VDD_GX_NOMINAL_L1] = 825000000},
	},
};
