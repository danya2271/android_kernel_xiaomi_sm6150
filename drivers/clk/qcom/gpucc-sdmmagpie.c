...
static int vdd_gx_corner[] = {
	...
	RPMH_REGULATOR_LEVEL_MIN_SVS - 8,		/* VDD_GX_MIN 48 */
	RPMH_REGULATOR_LEVEL_LOW_SVS - 12,		/* VDD_GX_LOWER 64 */
	RPMH_REGULATOR_LEVEL_SVS - 16,		/* VDD_GX_LOW 128 */
	RPMH_REGULATOR_LEVEL_SVS_L1 - 32,		/* VDD_GX_LOW_L1 192 */
	RPMH_REGULATOR_LEVEL_NOM - 48,		/* VDD_GX_NOMINAL 256 */
	RPMH_REGULATOR_LEVEL_NOM_L1 - 40,		/* VDD_GX_NOMINAL_L1 320 */
	RPMH_REGULATOR_LEVEL_TURBO,		/* VDD_GX_HIGH 384 */
	RPMH_REGULATOR_LEVEL_TURBO_L1,		/* VDD_GX_HIGH_L1 416 */
